package com.cj.core.utils.excle;//package com.cj.witcommon.utils.excle;
//
...
//import cn.mos.framework.base.domain.SessionBean;
...
//	public @ResponseBody EasyUIPage  queryList(SessionBean sessionBean, EasyUIPage page,ZrsBean domain,
//			@RequestParam(value = "rows", required = false) Integer rows) {
//		sessionBean = getSessionBean(sessionBean);
//		page.setPagePara(rows);
//		OrgOrganization org = null;
//		String orgCode=domain.getFqdwid();
//		boolean  city = false;
...
//					city = true;
//					domain.setBqddwbmid(org.getOrgcode());
//					domain.setXt_lrrszgsid(org.getOrgcode());
//					domain.setFqdwid(null);
//				//县级及以下所有数据 单根据setXt_lrrxgsid 可以查询
//				}else if(OrgUtils.ORGLEVEL_XGS.equals(orglevel)){
//					domain.setXt_lrrxgsid(org.getOrgcode());
//					domain.setZrslx("01");
//					domain.setBqddwbmid(org.getOrgcode());
//					domain.setFqdwid(null);
//				//省级数据以下所有数据 只需要 Xt_lrrdwid 即可
//				}else if(OrgUtils.ORGLEVEL_SGS.equals(orglevel)){
//					domain.setXt_lrrdwid(org.getOrgcode());
//					domain.setFqdwid(null);
//				}else if(OrgUtils.ORGLEVEL_SGSBM.endsWith(orglevel)){
//					domain.setFqbmid(org.getOrgcode());
//					domain.setFqdwid(null);
//				}
//				else if(OrgUtils.ORGLEVEL_SZGSBM.endsWith(orglevel)){
//					city = true;
//					domain.setQdrbmdmArray(org.getOrgcode());
//					domain.setFqbmid(org.getOrgcode());
//					domain.setFqdwid(null);
//				}else{
//					domain.setQdrbmdmArray(domain.getQdrbmdmArray());
//					domain.setZrslx("01");
//					domain.setFqbmid(org.getOrgcode());
//					domain.setFqdwid(null);
//				}
...
//			if ( OrgUtils.ORGLEVEL_SZGS.equals(orglevel)){
//				city = true;
//				domain.setBqddwbmid(domain.getFqdwid());
//			}else if(OrgUtils.ORGLEVEL_XGS.equals(orglevel)){
//				domain.setXt_lrrxgsid(org.getOrgcode());
//				domain.setZrslx("01");
//				domain.setBqddwbmid(org.getOrgcode());
...
//			return new EasyUIPage();
//		}
//		page = zrsService.queryList(domain,page,city);
//
...
//	public @ResponseBody Map<String,Object> delete(ZrsBean domain,SessionBean sessionBean) {
//		Map<String, Object> map = new HashMap<String, Object>();
//		sessionBean = getSessionBean(sessionBean);
//		try {
//			String resuleses = zrsService.del(domain,sessionBean);
...
//		modelAndView.addObject("domain", zrsService.querySingle(id));
//		return modelAndView;
//	}
//
...
//		modelAndView.addObject("domain", zrsBean);
...
//
//	@RequestMapping("/save")
//	public ModelAndView save(ZrsBean domain, SessionBean sessionBean){
//		sessionBean = getSessionBean(sessionBean);
//		ModelAndView mv = new ModelAndView(getViewName(sessionBean));
//		Map<String, Object> model = new HashMap<String, Object>();
//		try {
...
//					    char[] chars = domain.getQdnr().toString().toCharArray();
//					    for (int i = 0; i < chars.length; i++) {
//					    	if((int)chars[i]> 31 || (int)chars[i] < 14){
//							            sbu.append(chars[i]);
//					    	}
//					    }
//					domain.setQdnr(sbu.toString());
//					zrsService.save(domain, sessionBean);
//			}
//			model.put(AppConst.STATUS, AppConst.SUCCESS);
//			model.put(AppConst.MESSAGES, getAddSuccess());
//		} catch (RuntimeException e) {
...
//		ZrsBean domain = JSON.parseObject(entityData, new TypeReference<ZrsBean>(){});
//		if	("false".equals(isdel)){
//			List<ZrsqdrBean> zrsqdrBeans = JSON.parseArray(zrsqdrentityData, ZrsqdrBean.class);
//			try {
//				zrsService.saveDataFromProvice(domain, zrsqdrBeans, sessionBean);
//				map.put(AppConst.STATUS, AppConst.SUCCESS);
//				map.put(AppConst.MESSAGES, getAddSuccess());
//			} catch (RuntimeException e) {
//				logger.error(e.getLocalizedMessage(), e);
...
//			try {
//				zrsService.delFromProvince(domain,sessionBean);
//				map.put(AppConst.STATUS, AppConst.SUCCESS);
//				map.put(AppConst.MESSAGES, getAddSuccess());
//			} catch (Exception e) {
//				logger.error(e.getLocalizedMessage(), e);
...
//		}
//
//		ZrsqdrBean domain = JSON.parseObject(entityData, new TypeReference<ZrsqdrBean>(){});
//		SessionBean sessionBean = JSON.parseObject(sessionData, new TypeReference<SessionBean>(){});
//		try {
//			zrsService.saveDataFromCity(domain, sessionBean);
//			map.put(AppConst.STATUS, AppConst.SUCCESS);
//			map.put(AppConst.MESSAGES, getAddSuccess());
//		} catch (RuntimeException e) {
//			logger.error(e.getLocalizedMessage(), e);
...
//	@ResponseBody
//	public ApiResult<String, Object> exportExcel(SessionBean sessionBean,HttpServletResponse response){
//		sessionBean = getSessionBean(sessionBean);
//		Map<String, Object> model = new HashMap<String, Object>();
//		OrgOrganization org = OrgUtils.getSsdw(sessionBean);
