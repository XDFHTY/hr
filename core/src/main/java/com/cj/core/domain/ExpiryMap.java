...
//
//        //声明一个默认过期时间为1秒的map
//        ExpiryMap<String, String> map = new ExpiryMap<>(1000);
//        map.put("test", "ankang");
...
//        Thread.sleep(1000);
//        System.out.println("test过期了?"+map.checkExpiry("test",true));
//        System.out.println("test1过期了?"+map.checkExpiry("test1",true));
//        System.out.println("test2过期了?"+map.checkExpiry("test2",true));
//
