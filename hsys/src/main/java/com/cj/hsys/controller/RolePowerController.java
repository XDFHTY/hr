...
@RestController
@RequestMapping("/system/api/v1/rolepower")
@Api(tags = "系统管理: 权限管理")
public class RolePowerController {
    ...
    @Log(name = "权限管理",value = "查询所有角色信息以及系统权限列表")
...
//    }
    ...
    @Log(name = "权限管理",value = "根据角色ID查询权限列表")
    ...
    public ApiResult findModularByRoleId(String json){
        ...
        return ResultUtil.result(rolePowerService.findModularByRoleId(json));
    ...
    @Log(name = "权限管理",value = "根据角色ID修改角色权限")
    ...
    @ApiOperation("重新读取权限信息")
    @Log(name = "权限管理",value = "重新读取权限信息")
